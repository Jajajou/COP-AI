...
# --- 1. LLM Setup ---
# Model lớn cho các Sĩ quan xử lý chuyên sâu
llm_agent = ChatGroq(temperature=0, model_name="llama-3.3-70b-versatile", api_key=config.GROQ_API_KEY)
# Model nhỏ, cực nhanh cho Supervisor để tránh Rate Limit
